...
{{
  "resume": "résumé fidèle",
  "sujet_principal": "sujet réellement compris",
  "audience_cible": "audience probable ou inconnue",
  "hook_reel": "première accroche réellement prononcée",
  "note_hook": 0,
  "note_clarte": 0,
  "note_structure": 0,
  "note_potentiel_viral": 0,
  "diagnostic_3_premieres_secondes": "diagnostic concret",
  "promesse": "promesse détectée ou chaîne vide",
  "preuve": "preuve détectée ou chaîne vide",
  "appel_action": "appel à l'action ou chaîne vide",
  "mots_remplissage": ["mot réellement présent"],
  "repetitions": ["répétition réellement présente"],
  "phrases_a_supprimer": ["citation exacte supprimable"],
  "points_forts": ["point fort"],
  "points_faibles": ["point faible"],
  "recommandations": ["action concrète"],
